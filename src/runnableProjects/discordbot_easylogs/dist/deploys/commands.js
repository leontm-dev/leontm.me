...
// Code
const rest = new discord_js_1.REST().setToken(String(process.env.DISCORDBOT_EASYLOGS_TOKEN));
(() => __awaiter(void 0, void 0, void 0, function* () {
    try {
        console.log(`Started refreshing ${commands.length} application (/) commands.`);
        // The put method is used to fully refresh all commands in the guild with the current set
        const data = yield rest.put(discord_js_1.Routes.applicationCommands(process.env.DISCORDBOT_EASYLOGS_CLIENT_ID), { body: commands });
